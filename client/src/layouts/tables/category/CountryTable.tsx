...
const initCountry: TCreateCountryRequest = {
    code: "",
    nameVI: "",
    nameEN: "",
};
...
const CountryTable = () => {
    ...
    const [createData, setCreateData] = useState<TCreateCountryRequest>({
        ...initCountry,
    });
    ...
    const renderCell = useCallback(
        (item: TCountryDto, columnKey: string | number) => {
            switch (columnKey) {
                case "code":
                    return (
                ...
                default:
                    return <div>{item[columnKey as keyof TCountryDto]}</div>;
            }
        },
