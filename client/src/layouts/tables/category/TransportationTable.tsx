...
const initTransportation: TCreateTransportationRequest = {
    code: "",
    nameVI: "",
    nameEN: "",
};
...
const TransportationTable = () => {
    ...
    const [createData, setCreateData] = useState<TCreateTransportationRequest>({
        ...initTransportation,
    });
    ...
    const closeCreateModal = useCallback(() => {
        ...
        setCreateData({ ...initTransportation });
    }, []);
    ...
    const renderCell = useCallback(
        (item: TTransportationDto, columnKey: string | number) => {
            switch (columnKey) {
                case "code":
                    return (
                ...
                default:
                    return (
                        <div>{item[columnKey as keyof TTransportationDto]}</div>
                    );
            }
        },
