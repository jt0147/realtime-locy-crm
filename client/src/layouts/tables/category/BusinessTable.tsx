...
type TData = TTableData<TBusinessDto>;
...
const initBusiness: TCreateBusinessRequest = {
    code: "",
    nameVI: "",
    nameEN: "",
};
...
const BusinessTable = () => {
    ...
    const [createData, setCreateData] = useState<TCreateBusinessRequest>({
        ...initBusiness,
    });
    const [updateSelected, setUpdateSelected] =
        useState<TUpdateBusinessRequest | null>(null);
    ...
    const closeCreateModal = useCallback(() => {
        ...
        setCreateData({ ...initBusiness });
    }, []);

    const handleCreate = useCallback(
        async (data: TCreateBusinessRequest) => {
    ...
    const handleUpdate = useCallback(
        async (data: TUpdateBusinessRequest) => {
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    const renderCell = useCallback(
        (item: TBusinessDto, columnKey: string | number) => {
            switch (columnKey) {
                case "code":
                    return (
                ...
                default:
                    return <div>{item[columnKey as keyof TBusinessDto]}</div>;
            }
        },
