...
const initPosition: TCreatePositionRequest = {
    code: "",
    nameVI: "",
    nameEN: "",
};
...
const PositionTable = () => {
    ...
    const [createData, setCreateData] = useState<TCreatePositionRequest>({
        ...initPosition,
    });
    ...
    const renderCell = useCallback(
        (item: TPositionDto, columnKey: string | number) => {
            switch (columnKey) {
                case "code":
                    return (
                ...
                default:
                    return <div>{item[columnKey as keyof TPositionDto]}</div>;
            }
        },
