...
import { TUpdateTypeOfCustomerRequest } from "@/types";
import { notification } from "@/utilities";

import { TUpdateModalProps } from "../../types";

const UpdateTypeOfCustomerModal = ({
    isOpen,
    onClose: onCloseProp,
    onSubmit,
    ...
    loading,
    item,
}: TUpdateModalProps<TUpdateTypeOfCustomerRequest>) => {
    const [data, setData] = useState<TUpdateTypeOfCustomerRequest | null>(null);
...
export default UpdateTypeOfCustomerModal;
