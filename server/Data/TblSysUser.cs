...
public partial class TblSysUser
{
    ...
    public virtual ICollection<TblNotifyWeb> TblNotifyWebIduserGuiNavigations { get; set; } = new List<TblNotifyWeb>();

    public virtual ICollection<TblNotifyWeb> TblNotifyWebIduserLienQuanNavigations { get; set; } = new List<TblNotifyWeb>();

    public virtual ICollection<TblNotifyWeb> TblNotifyWebIduserNhanNavigations { get; set; } = new List<TblNotifyWeb>();
