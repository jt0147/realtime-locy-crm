...
public partial class VslCrmContext : DbContext
{
    ...
    public virtual DbSet<TblNotifyWeb> TblNotifyWebs { get; set; }

    public virtual DbSet<TblNotifyWebMessage> TblNotifyWebMessages { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TblDmcustomer>(entity =>
        {
            ...
            entity.Property(e => e.MauTacNghiepCuoi).HasMaxLength(150);
        ...
        modelBuilder.Entity<TblNotifyWeb>(entity =>
        {
            entity.ToTable("tblNotifyWeb");

            entity.Property(e => e.Id).HasColumnName("ID");
            entity.Property(e => e.DateCreate).HasColumnType("datetime");
            entity.Property(e => e.Iddmmess).HasColumnName("IDDMMess");
            entity.Property(e => e.IduserGui).HasColumnName("IDUserGui");
            entity.Property(e => e.IduserLienQuan).HasColumnName("IDUserLienQuan");
            entity.Property(e => e.IduserNhan).HasColumnName("IDUserNhan");

            entity.HasOne(d => d.IddmmessNavigation).WithMany(p => p.TblNotifyWebs)
                .HasForeignKey(d => d.Iddmmess)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_tblNotifyWeb_tblNotifyWebMessage");

            entity.HasOne(d => d.IduserGuiNavigation).WithMany(p => p.TblNotifyWebIduserGuiNavigations)
                .HasForeignKey(d => d.IduserGui)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_tblNotifyWeb_tblSysUser");

            entity.HasOne(d => d.IduserLienQuanNavigation).WithMany(p => p.TblNotifyWebIduserLienQuanNavigations)
                .HasForeignKey(d => d.IduserLienQuan)
                .HasConstraintName("FK_tblNotifyWeb_tblSysUser2");

            entity.HasOne(d => d.IduserNhanNavigation).WithMany(p => p.TblNotifyWebIduserNhanNavigations)
                .HasForeignKey(d => d.IduserNhan)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_tblNotifyWeb_tblSysUser1");
        });

        modelBuilder.Entity<TblNotifyWebMessage>(entity =>
        {
            entity.ToTable("tblNotifyWebMessage");
